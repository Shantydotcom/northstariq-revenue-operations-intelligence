...
| Forecast Integrity *(open Opportunities, not a stage)* | `PD-23` — governs only Opportunities promoted into `Best Case` or `Commit`. **Policy ratified 2026-09-04; registered and active since Model v4, not yet runtime validated.** |
